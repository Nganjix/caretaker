...
INSERT INTO `accounts` VALUES (2,'MLP001','mpesa account',1,'2017-02-12 00:00:00','2017-02-12 00:00:00'),(4,'KCB 47477HHDJ#',NULL,0,NULL,NULL),(6,'Victoria Bank',NULL,0,NULL,NULL),(7,'test',NULL,0,NULL,NULL);
...
INSERT INTO `paymentperiods` VALUES (13,'1','january','1','31'),(14,'2','february','1','28'),(15,'3','march','1','31'),(16,'4','april','1','30'),(17,'5','may','1','31'),(18,'6','june','1','30'),(19,'7','july','1','31'),(20,'8','august','1','31'),(21,'9','september','1','30'),(22,'10','october','1','31'),(23,'11','november','1','30'),(24,'12','december','1','31');
...
INSERT INTO `roles` VALUES (35,4,6,1490266082,NULL),(36,5,1,1490274237,NULL),(7,3,8,1490252580,NULL),(4,3,13,1490128927,NULL),(5,3,4,1490166932,NULL),(11,3,6,1490253257,NULL),(21,3,1,1490257411,NULL),(34,4,5,1490266082,NULL),(17,3,11,1490255303,NULL),(25,3,9,1490258501,NULL),(26,3,10,1490258501,NULL),(33,4,4,1490266082,NULL),(32,4,1,1490266082,NULL),(29,3,15,1490258501,NULL),(30,3,16,1490258501,NULL),(31,3,17,1490258501,NULL),(37,5,2,1490274237,NULL),(38,5,4,1490274237,NULL),(39,5,6,1490274237,NULL);
...
INSERT INTO `screens` VALUES (1,'accounts','Accounts','php',1),(2,'apartment','Apartment','php',1),(3,'blocks','Blocks','php',1),(4,'company','Company','php',1),(5,'estates','Estates','php',1),(6,'index','Overview','php',1),(7,'validate','validate','php',0),(8,'notifications','Notifications','php',1),(9,'notificationtemplates','Notification Templates','php',1),(10,'paymentperiods','Payment Periods','php',1),(11,'profile','Profile','php',1),(12,'reports','Reports','php',1),(13,'roles','Access Permissions','php',1),(14,'template','Template','php',0),(15,'tenant','Tenant','php',1),(16,'transactions','Transactions','php',1),(17,'users','Users','php',1),(18,'tester','Tester','php',0);
...
INSERT INTO `tenant` VALUES (1,'Saturn','doejahz',NULL,554445,1,'lol@gmail.com',0,1477947600000,NULL,NULL,65,7867,'mhj','h',76577,76599,500.00,3,NULL,NULL,NULL),(2,'John','Hancock',NULL,5687,1,'get@gmail.com',1,1479070800000,NULL,NULL,767665,9877777,'Mantra','Lolhjhh',987666,6554434,1200.00,3,NULL,NULL,NULL);
...
INSERT INTO `users` VALUES (3,'james','$2y$10$8sF34.FSmAJbm4PLiP07PeukCNMxWYNR4RcQIx/UpgHQ7G0TqU.3a',1489484578,NULL),(4,'modal','$2y$10$ysQk.wCQETPXeQtXYDYijOqKLBQOfM5YM1cuogdClqtIC52JMNeB2',1490265973,NULL),(5,'lenny','$2y$10$8w7xlsX7sHAHFMM4yiOj0ulcnFt.asV17DteBgbnftOaPxdEbYQta',1490274155,NULL);
...
-- Dump completed on 2017-03-23 19:09:05
