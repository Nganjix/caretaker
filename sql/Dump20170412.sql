...
--
-- Host: 192.168.0.1    Database: caretaker
-- ------------------------------------------------------
...
INSERT INTO `accounts` VALUES (2,'MLP001','mpesa account devel',1,'2017-02-12 00:00:00','2017-02-12 00:00:00'),(4,'KCB 47477hghHHDJ#','this is a test message ooooh',1,NULL,NULL),(6,'Victoria Bank','test bank victoria of africa',1,NULL,NULL);
...
CREATE TABLE `apartment` (
  ...
  `aprtDesc` varchar(100) DEFAULT NULL,
...
INSERT INTO `apartment` VALUES (5,'A462','Best apartment with a bedroom and bathroom',3,3,45000.00,555,111,15576,1487273647,1491835656),(6,'456G','best apartment',2,3,50000.00,NULL,NULL,NULL,1491844671,NULL);
...
CREATE TABLE `cumulativepayments` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_index` (`paymentperiod`,`tenantid`,`year`)
...
CREATE TABLE `paymentperiods` (
  ...
  `periodDesc` varchar(45) NOT NULL,
  `startDay` int(25) NOT NULL,
  `lastDay` int(25) NOT NULL,
  `year` int(11) NOT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `unique_index` (`periodName`,`year`)
...
INSERT INTO `paymentperiods` VALUES (13,'1','january',1,31,2017),(14,'2','february',1,28,2017),(15,'3','march',1,31,2017),(16,'4','april',1,30,2017),(17,'5','may',1,31,2017),(18,'6','june',1,30,2017),(19,'7','july',1,31,2017),(20,'8','august',1,31,2017),(21,'9','september',1,30,2017),(22,'10','october',1,31,2017),(23,'11','november',1,30,2017),(24,'12','december',1,31,2017);
...
INSERT INTO `roles` VALUES (40,3,2,1490477580,NULL),(36,5,1,1490274237,NULL),(7,3,8,1490252580,NULL),(4,3,13,1490128927,NULL),(5,3,4,1490166932,NULL),(11,3,6,1490253257,NULL),(21,3,1,1490257411,NULL),(34,4,5,1490266082,NULL),(17,3,11,1490255303,NULL),(25,3,9,1490258501,NULL),(26,3,10,1490258501,NULL),(33,4,4,1490266082,NULL),(32,4,1,1490266082,NULL),(29,3,15,1490258501,NULL),(30,3,16,1490258501,NULL),(31,3,17,1490258501,NULL),(37,5,2,1490274237,NULL),(38,5,4,1490274237,NULL),(39,5,6,1490274237,NULL),(41,3,3,1490553402,NULL),(42,3,5,1490553402,NULL),(43,3,12,1490553402,NULL),(44,3,19,1490733072,NULL),(45,3,20,1491764097,NULL);
...
INSERT INTO `screens` VALUES (1,'accounts','Accounts','php',1,1,19),(2,'apartment','Apartment','php',1,1,19),(3,'blocks','Blocks','php',1,1,19),(4,'company','Company','php',1,1,19),(5,'estates','Estates','php',1,1,19),(6,'index','Overview','php',1,1,1),(7,'validate','validate','php',0,1,19),(8,'notifications','Notifications','php',1,1,19),(9,'notificationtemplates','Notification Templates','php',1,1,19),(10,'paymentperiods','Payment Periods','php',1,1,19),(11,'profile','Users Profile','php',1,1,19),(12,'reports','Reports','php',1,1,19),(13,'roles','Access Permissions','php',1,1,19),(14,'template','Template','php',0,1,19),(15,'tenant','Tenant Details','php',1,1,19),(16,'transactions','Transactions','php',1,1,2),(17,'users','Users','php',1,1,19),(18,'tester','Tester','php',0,1,19),(19,'addpayment','Add Payment','php',1,1,19),(20,'settings','System Settings','php',1,1,20);
...
CREATE TABLE `tenant` (
  ...
  `monthlyrent` decimal(20,0) NOT NULL,
...
INSERT INTO `tenant` VALUES (1,'Saturn','doejah',NULL,554445,1,'lol@gmail.com',1,1477947600000,NULL,NULL,65,7867,'Mwana','Wikwe',76577,76599,500.00,3,8500,NULL,NULL),(2,'John Teh','Hancock',NULL,5687,1,'get@gmail.com',1,1479070800000,NULL,NULL,767665,9877777,'Mantra','Lolhjhh',987666,6554434,1200.00,3,0,NULL,NULL),(3,'Mary','Anzoo',NULL,7688654,0,'mary@gmail.com',1,1491771600000,NULL,NULL,786785345,0,'Ken','Oloo',5687665,754675786,5000.00,6,15000,NULL,NULL);
...
-- Dump completed on 2017-04-12 12:29:36
